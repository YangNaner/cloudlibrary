...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="${pageContext.request.contextPath}/admin/index.jsp" class="logo">
            ...
            <span class="logo-lg"><b>云借阅-图书借阅系统</b></span>
        </a>
            ...
            <ul class="sidebar-menu">
                <li id="admin-index">
                    <a href="${pageContext.request.contextPath}/admin/index.jsp">
                        <i class="fa fa-dashboard"></i> <span>新书推荐</span>
                    </a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/bookServlet?method=search" target="iframe">
                        <i class="fa fa-circle-o"></i>图书借阅
                    </a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/bookServlet?method=searchBorrowed" target="iframe">
                        <i class="fa fa-circle-o"></i>当前借阅
                    </a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/recordServlet?method=searchRecords" target="iframe">
    ...
    <div class="content-wrapper">
        <iframe width="100%" id="iframe" name="iframe" onload="SetIFrameHeight()"
                frameborder="0" src="${pageContext.request.contextPath}/bookServlet?method=selectNewbooks"></iframe>
    </div>
</div>
