...
<div class="loginmanage">
    <div class="py-container">
        <h4 class="manage-title">云借阅-图书借阅系统</h4>
        <div class="loginform">
            ...
            <div class="tab-content tab-wraped">
                ...
                <div id="profile" class="tab-pane  active">
                    <form id="loginform" class="sui-form" action="${pageContext.request.contextPath}/userServlet?method=login"
                          method="post">
                        <div class="input-prepend"><span class="add-on loginname">用户名</span>
                            <input type="text" placeholder="请输入用户名" class="span2 input-xfat" name="email">
                        </div>
